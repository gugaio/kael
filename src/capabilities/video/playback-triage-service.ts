...
function normalizePlaybackEvents(input: PlaybackSessionInput): PlaybackEvent[] {
...
function buildSummary(player: PlaybackSessionInput["player"], issues: PlaybackIssue[]): string {
