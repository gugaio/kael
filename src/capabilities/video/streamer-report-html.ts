import type { StreamerOriginAnalysisReport, StreamerSegmentAnalysisEntry } from "./types.js";
...
<head>
  ...
  <title>Kael Stream Analysis - ${escapeHtml(report.originId)}</title>
  <style>
    :root {
      color-scheme: light;
      --bg: #f7f8f5;
...
<body>
  ...
  <main>
    ...
    <script id="kael-analysis-json" type="application/json">${escapeScriptJson(JSON.stringify(report))}</script>
  </main>
</body>
</html>
`;
